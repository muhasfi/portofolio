...
(function () {
  const techs = [
    ...
    {
      name: "Express",
      svg: `<svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"><path fill="#fff" d="M126.67 98.44c-4.56 1.16-7.38.05-9.91-3.75-5.68-8.51-11.95-16.63-18-24.9-.78-1.07-1.59-2.12-2.6-3.45C89 73.51 81.85 82.28 75.15 91.26c-2.69 3.61-5.11 4.96-9.6 3.6l18.97-26.17L67.11 43c4.56-1.16 7.38-.05 9.91 3.75 5.68 8.51 11.95 16.63 18 24.9.78 1.07 1.59 2.12 2.6 3.45 7.15-8.44 14.31-16.59 20.99-25.22 2.72-3.4 5.29-4.83 9.67-3.4L111.74 69.6l14.93 28.84zM1.33 61.74c.72-3.61 1.2-7.29 2.2-10.83 6-21.39 27.05-33.06 48.7-28.09 14.88 3.49 23.61 13.42 27.3 27.89 1.01 3.97 1.37 8.08 2.04 12.14H9.38c-.63 17.29 10.97 27.85 28.24 25.88 6.18-.72 11.61-3.22 15.55-8.29 1.35-1.72 2.75-2.63 4.93-2.34 3.82.52 6.61.12 7.73 4.74-9.82 11.53-22.19 16.83-37.47 14.05C12.83 94.43 3.86 84 1.81 72.55c-.32-1.83-.47-3.7-.69-5.55-.01-1.75-.01-3.51 0-5.26zM9.11 55.5h63.64c-1.51-16.76-11.09-25.39-28.08-24.81C27.79 31.28 10.54 43.11 9.11 55.5z"/></svg>`,
    },
    {
      name: "Vue.js",
